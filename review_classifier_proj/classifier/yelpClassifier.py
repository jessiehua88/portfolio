...
>>>>>>> c94ae4fe9a573df62ab8db3cc97856f3a80114a1
        LIKELIHOODS = {}
...
>>>>>>> c94ae4fe9a573df62ab8db3cc97856f3a80114a1
    ...
    def counts_to_probabilities(self, num_stars_and_word_counts):
        # raise NotImplementedError()
        # 3. [((num_stars, word_in_review), num_reviews_with_word_and_stars)] --> [(num_stars, {word : probability_in_review_of_num_stars})]
        num_stars = num_stars_and_word_counts[0][0].encode('ascii', 'ignore')
        word = num_stars_and_word_counts[0][1].encode('ascii', 'ignore')
        # probability = float(num_stars_and_word_counts[1]) / float(self.NUM_WORDS[int(num_stars_and_word_counts[0][0].encode('ascii', 'ignore'))])
        probability = self.compute_likelihood(num_stars_and_word_counts[1], num_stars)
