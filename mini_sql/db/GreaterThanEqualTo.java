...
public class GreaterThanEqualTo implements Comparator{
    ...
    public boolean compare(Item x, String literal) {
        ...
        throw new RuntimeException("ERROR: Comparing item and literal with different types.");
    }
    ...
    public boolean compare(Item x, Item y) {
        ...
        if (x.getType().equals(y.getType())) {
            if (x.getType().equals("int")) {
                ...
                return x.getValue().toString().compareTo(String.valueOf(y.getValue().toString())) >= 0;
            }
        ...
        throw new RuntimeException("ERROR: Comparing items with different types.");
    }
}
